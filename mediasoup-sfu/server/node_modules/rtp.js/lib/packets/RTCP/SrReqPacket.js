 ...
 */
class SrReqPacket extends FeedbackPacket_1.FeedbackPacket {
    /**
     ...
     */
    constructor(view) {
        super(RtcpPacket_1.RtcpPacketType.RTPFB, FeedbackPacket_1.RtpFeedbackMessageType.SR_REQ, view);
        if (!this.view) {
...
exports.SrReqPacket = SrReqPacket;
