...
test('read3BytesInDataView()', () => {
    ...
    expect((0, byteOps_1.read3BytesInDataView)({ view, pos: 4 })).toBe(8405024);
});
test('write3BytesInDataView()', () => {
    (0, byteOps_1.write3BytesInDataView)({ view, pos: 1, value: 8405024 });
    expect((0, byteOps_1.read3BytesInDataView)({ view, pos: 1 })).toBe(8405024);
});
test('readSigned3BytesInDataView()', () => {
    ...
    expect((0, byteOps_1.readSigned3BytesInDataView)({ view, pos: 8 })).toBe(8388607);
    // Bytes 12, 13 and 14 in the array are number -1.
    expect((0, byteOps_1.readSigned3BytesInDataView)({ view, pos: 12 })).toBe(-1);
    ...
    expect((0, byteOps_1.readSigned3BytesInDataView)({ view, pos: 16 })).toBe(-8388608);
});
test('writeSigned3BytesInDataView()', () => {
    (0, byteOps_1.writeSigned3BytesInDataView)({ view, pos: 0, value: 8388607 });
    expect((0, byteOps_1.readSigned3BytesInDataView)({ view, pos: 0 })).toBe(8388607);
    (0, byteOps_1.writeSigned3BytesInDataView)({ view, pos: 0, value: -1 });
    expect((0, byteOps_1.readSigned3BytesInDataView)({ view, pos: 0 })).toBe(-1);
    (0, byteOps_1.writeSigned3BytesInDataView)({ view, pos: 0, value: -8388608 });
    expect((0, byteOps_1.readSigned3BytesInDataView)({ view, pos: 0 })).toBe(-8388608);
});
