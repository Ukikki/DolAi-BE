...
const ExtendedJitterReportsPacket_1 = require("../../../packets/RTCP/ExtendedJitterReportsPacket");
const RtcpPacket_1 = require("../../../packets/RTCP/RtcpPacket");
const helpers_1 = require("../../../utils/helpers");
const extendedJitterReportsPacketDump = {
    byteLength: 12,
    padding: 0,
    packetType: RtcpPacket_1.RtcpPacketType.IJ,
    count: 2,
...
const array = new Uint8Array([
    0x82, 0xc3, 0x00, 0x02,
    0x11, 0x22, 0x33, 0x44,
    0x55, 0x66, 0x77, 0x88 // Jitter: 0x55667788
]);
...
describe('parse RTCP Extended Jitter Reports packet', () => {
    ...
    test('packet processing succeeds', () => {
        const packet = new ExtendedJitterReportsPacket_1.ExtendedJitterReportsPacket(view);
...
describe('create RTCP Extended Jitter Reports packet', () => {
    const packet = new ExtendedJitterReportsPacket_1.ExtendedJitterReportsPacket();
